    ...
    >
      <div>
        ...
        <div className="line-holder" style={{ position: 'absolute', bottom: '500px', left: '0px' }}>
          <svg width="500" height="1000" style={{ position: 'absolute', top: '-200px', left: '0' }}
            ...
            <EnergyLines flow={flowData} pvPoint={pvPoint}
                         ...
                         gridPoint={gridPoint} extraEnergyPoint={additionalPoint} alwaysShowAdditionalSource={options.additionalSourceAlwaysShow} showEnergyThreshold={options.showEnergyThreshold}/>
          </svg>
        </div>
        ...
        <div className="line-holder" style={{ position: 'absolute', bottom: '0px', left: '25px' }}>
          ...
          { ((Math.abs(flowData.additionalSource) > options.showEnergyThreshold) || (flowData.additionalSourceSOC !== 0) || options.additionalSourceAlwaysShow) && (
