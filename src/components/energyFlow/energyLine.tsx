...
export const EnergyLines: React.FC<EnergyLinesProps> = ({flow, pvPoint, loadPoint, gridPoint, extraEnergyPoint, linesColor, alwaysShowAdditionalSource, showEnergyThreshold}) => {
  return (
    <>
